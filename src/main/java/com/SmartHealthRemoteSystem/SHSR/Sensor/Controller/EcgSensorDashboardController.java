...
@Controller
public class EcgSensorDashboardController {
    ...
    @GetMapping("/patient/ecgDashboard")
    public String viewEcgSensorDashboard(Model model) throws Exception {
