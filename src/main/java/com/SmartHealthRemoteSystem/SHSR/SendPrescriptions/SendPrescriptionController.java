...
public class SendPrescriptionController {
    ...
    //                                      @RequestParam List<String> patientMedList,
    //                                      Model model) throws Exception {

    //     Prescription newPrescription = new Prescription(doctorId, patientMedList, prescription, diagnosisAilment);
    //     prescriptionService.createPrescription(patientId, newPrescription);

    //     Doctor doctor = doctorService.getDoctor(doctorId);
    //     List<Patient> patientList = doctorService.findAllPatientAssignToDoctor(doctorId);
